...
fichiers <- list.files("C:/Users/ottavig/Desktop/stock_ods/")
...
path <- "C:/Users/ottavig/Desktop/stock_ods/"
...
#CODE DATE
if(as.numeric(names(sort(table(df$V2)[],decreasing = T)[1])) != as.numeric(paste0(substr(Sys.Date(),1,4),substr(Sys.Date(),6,7))) -1 ) rapport_final[9,"MARK"] <- rapport_final[9,"MARK"] + 1
